...
import { authCheck, isLoggedIn, isTokenInBlackList } from '../middleware/middleware';
...
router.route('/login').post(authCheck, catchAsync(isTokenInBlackList), userController.loginUser);
