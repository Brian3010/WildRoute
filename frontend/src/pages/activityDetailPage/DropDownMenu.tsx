...
import { IconButton, Menu, MenuItem, Snackbar, Tooltip, Typography } from '@mui/material';
      ...
      >
        <Tooltip title={isOwnner ? '' : 'Only the owner can do this'} placement="top-start">
          <span>
            ...
            <MenuItem sx={{ gap: 1.5, color: '#d32f2f' }} onClick={handleDelete} disabled={isOwnner ? false : true}>
